...
public class ThrowRock {
	...
	public ThrowRock(Direction d, int fromX, int fromY, int fromT) {
		this.direction = d;
		this.fromX = fromX;
		this.fromY = fromY;
		this.toX = fromX;
	...
	public String toString() {
		return "Rock Thrown [direction=" + direction + ", fromX=" + fromX + ", fromY=" + fromY + ", toX=" + toX + ", toY=" + toY + ", fromT=" + fromT + ", toT=" + toT + "]";
	}
}
